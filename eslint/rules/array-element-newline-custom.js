...
module.exports = {
  ...
  create(context) {
    ...
    function check(node) {
      ...
      console.log(JSON.stringify(elements[elements.length-1]))
      const begBracketOfObjectOnSameLine = astUtils.isTokenOnSameLine(openBracket, sourceCode.getFirstToken(elements[elements.length-1])) || false
